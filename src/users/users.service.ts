...
export class UsersService {
  ...
  async updateUser(userId: number, updateUserDto : UpdateUserDto): Promise<User> {
    ...
    return this.prismaService.user.update({ where: { id: userId }, data: updateUserDto });
  }
  ...
  async changePassword(userId: number, changePasswordDto: ChangePasswordDto): Promise<string> {
    ...
    const isOldPasswordValid = await argon.verify(user.password, changePasswordDto.oldPassword);
